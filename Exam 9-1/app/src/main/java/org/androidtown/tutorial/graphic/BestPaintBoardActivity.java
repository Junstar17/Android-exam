    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        radioButton1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                board.setPainter(1);
                Toast.makeText(getApplication(),"Butt으로 변경되었습니다.",Toast.LENGTH_LONG).show();
            }
        });
        radioButton2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                board.setPainter(2);
                Toast.makeText(getApplication(),"Round으로 변경되었습니다.",Toast.LENGTH_LONG).show();
            }
        });
        radioButton3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                board.setPainter(3);
                Toast.makeText(getApplication(),"Square으로 변경되었습니다.",Toast.LENGTH_LONG).show();
            }
        });
